...
func TestControllerHandleAlbum(t *testing.T) {
	t.Run("Positive", func(t *testing.T) {
		...
		sched := service.NewScheduler("HVyMn8HuDa8rdkyr", &data)
	...
	t.Run("Negative1", func(t *testing.T) {
		...
		stor := storage.NewMock()
		data := database.NewMem()
		sched := service.NewScheduler("mEdFrvE3549LDFzx", &data)
		serv := service.NewService(&comp, &stor, &data, &data, &sched)
		contr := newController(&serv)
		fn := contr.handleAlbum()
		w := httptest.NewRecorder()
	...
	t.Run("Negative2", func(t *testing.T) {
		...
		stor := storage.NewMock()
		data := database.NewMem()
		sched := service.NewScheduler("xQWGJjTtetde2DdB", &data)
		serv := service.NewService(&comp, &stor, &data, &data, &sched)
		contr := newController(&serv)
		fn := contr.handleAlbum()
		w := httptest.NewRecorder()
	...
	t.Run("Negative3", func(t *testing.T) {
		...
		stor := storage.NewMock()
		data := database.NewMem()
		sched := service.NewScheduler("eQupRzAY56Qp5E4U", &data)
		serv := service.NewService(&comp, &stor, &data, &data, &sched)
		contr := newController(&serv)
		fn := contr.handleAlbum()
		w := httptest.NewRecorder()
	...
	t.Run("Negative4", func(t *testing.T) {
		...
		stor := storage.NewMock()
		data := database.NewMem()
		sched := service.NewScheduler("Au4DBRQhyEJV99wh", &data)
		serv := service.NewService(&comp, &stor, &data, &data, &sched)
		contr := newController(&serv)
		fn := contr.handleAlbum()
		w := httptest.NewRecorder()
	...
	t.Run("Negative5", func(t *testing.T) {
		...
		stor := storage.NewMock()
		data := database.NewMem()
		sched := service.NewScheduler("UcNgY7Acvep8XqCc", &data)
		serv := service.NewService(&comp, &stor, &data, &data, &sched)
		contr := newController(&serv)
		fn := contr.handleAlbum()
		w := httptest.NewRecorder()
...
func TestControllerHandlePair(t *testing.T) {
	t.Run("Positive", func(t *testing.T) {
		...
		stor := storage.NewMock()
		data := database.NewMem()
		sched := service.NewScheduler("93P3AU2V6RMcFND4", &data)
		serv := service.NewService(&comp, &stor, &data, &data, &sched)
		contr := newController(&serv)
		fn := contr.handleAlbum()
		w := httptest.NewRecorder()
	...
	t.Run("Negative", func(t *testing.T) {
		...
		stor := storage.NewMock()
		data := database.NewMem()
		sched := service.NewScheduler("WTuVh4YDCdZM4af6", &data)
		serv := service.NewService(&comp, &stor, &data, &data, &sched)
		contr := newController(&serv)
		fn := contr.handlePair()
		w := httptest.NewRecorder()
...
func TestControllerHandleVote(t *testing.T) {
	t.Run("Positive", func(t *testing.T) {
		...
		stor := storage.NewMock()
		data := database.NewMem()
		sched := service.NewScheduler("3L8E2zrdQtmJKEwa", &data)
		serv := service.NewService(&comp, &stor, &data, &data, &sched)
		contr := newController(&serv)
		fn := contr.handleAlbum()
		w := httptest.NewRecorder()
	...
	t.Run("Negative1", func(t *testing.T) {
		...
		stor := storage.NewMock()
		data := database.NewMem()
		sched := service.NewScheduler("xGgXp5Pg5nKvGmBY", &data)
		serv := service.NewService(&comp, &stor, &data, &data, &sched)
		contr := newController(&serv)
		fn := contr.handleAlbum()
		w := httptest.NewRecorder()
	...
	t.Run("Negative2", func(t *testing.T) {
		...
		stor := storage.NewMock()
		data := database.NewMem()
		sched := service.NewScheduler("RkAD9BHx8mTUBYRj", &data)
		serv := service.NewService(&comp, &stor, &data, &data, &sched)
		contr := newController(&serv)
		fn := contr.handleAlbum()
		w := httptest.NewRecorder()
...
func TestControllerHandleTop(t *testing.T) {
	t.Run("Positive", func(t *testing.T) {
		...
		stor := storage.NewMock()
		data := database.NewMem()
		sched := service.NewScheduler("qCzDFPuY53Y34mdS", &data)
		serv := service.NewService(&comp, &stor, &data, &data, &sched)
	...
	t.Run("Negative", func(t *testing.T) {
		...
		stor := storage.NewMock()
		data := database.NewMem()
		sched := service.NewScheduler("732qurKQkxYDsG6L", &data)
		serv := service.NewService(&comp, &stor, &data, &data, &sched)
		contr := newController(&serv)
		fn := contr.handleTop()
		w := httptest.NewRecorder()
